...
export default function Users() {
  ...
  const { data, isLoading } = useQuery(
    ...
    useEffect(() => {
        setTotalPages(Math.ceil(currentCount / limit));
    }, [currentCount]);
    ...
    <Layout>
      ...
      <div className='button-container'>
        <button 
          ...
          disabled={page===1} 
          style={{ backgroundColor: page === 1 ? 'gray' : '#C1292E' }}
          >
          Anterior
        </button>
        <button 
          ...
          style={{ backgroundColor: page === totalPages ? 'gray' : '#C1292E' }}
        >
          Siguiente
        </button>
      </div>
